...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-70.4, -70.4, -10.0, 70.4, 70.4, 10.0],
            max_num=500,
            score_threshold=0.1,
            out_size_factor=8,
...
train_pipeline = [
    dict(
        type='PrepareImageInputsKitti',
        is_train=True,
        data_config=data_config),
    dict(
        type='LoadAnnotationsBEVDepthKitti',
...
test_pipeline = [
    dict(type='PrepareImageInputsKitti', data_config=data_config),
    dict(
        type='LoadAnnotationsBEVDepthKitti',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
